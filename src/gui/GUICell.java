...
public class GUICell extends JButton {
	...
	private static final Border QVISITEDSETBORDER = BorderFactory.createMatteBorder(2, 2, 2, 2, QVISITEDSETCOLOR);
	
	/** The Constant QVISITEDSETBORDER. */
	private static final Border QVISITEDPATHBORDER = BorderFactory.createMatteBorder(2, 2, 2, 2, QVISITEDPATHCOLOR);
